!function(e) {
    "use strict";
    if (e && !e.ymusicInitialized) {
        e.ymusicInitialized = !0;
        var t = "ytmusic-menu-service-item-renderer, paper-dialog { display: none; visibility: invisible; }", n = e.head || e.getElementsByTagName("head")[0], i = e.createElement("style");
        n.appendChild(i), i.type = "text/css", i.styleSheet ? i.styleSheet.cssText = t : i.appendChild(e.createTextNode(t)),
            function t() {
